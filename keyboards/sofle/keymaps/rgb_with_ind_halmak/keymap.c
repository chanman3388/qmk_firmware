 ...
 */
[_UPPER] = LAYOUT(
  _______, KC_NO , KC_NO , KC_NO , KC_NO , KC_PSCR,                           KC_NO,  KC_NO  , KC_NO,  KC_NO ,  KC_NO ,C(A(KC_DEL)),
  _______,  KC_NO,  KC_NO,   KC_LBRC,  KC_RBRC, KC_NO,                        KC_NO, KC_UP, KC_NO, KC_HOME,KC_PGUP, KC_BSPC,
  _______, KC_NO,  KC_NO,  KC_LSFT,  XXXXXXX, KC_NO,                       KC_LEFT,  KC_DOWN, KC_RIGHT, KC_END,  KC_PGDN, KC_BSPC,
  _______,KC_NO, KC_NO, KC_NO, KC_PASTE, KC_NO,  KC_NO,       KC_NO,  KC_NO, KC_NO, KC_NO, _______,   _______, _______,
                         _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______
)
};
