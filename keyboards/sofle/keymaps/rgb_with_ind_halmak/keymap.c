...
[_LOWER] = LAYOUT(
  ...
  KC_NO,  KC_EQL,     KC_MINS,KC_PLUS,KC_LCBR,KC_RCBR,_______,       _______,KC_LBRC, KC_RBRC, KC_SCLN, KC_COLN, KC_BSLS, KC_NO,
 ...
 */
[_UPPER] = LAYOUT(
  KC_NO,    KC_NO,  KC_NO,      KC_NO,      KC_NO,      KC_PSCR,                           KC_NO,  KC_NO, KC_NO,  KC_NO ,  KC_NO ,C(A(KC_DEL)),
